...
public class IdentityService {
    ...
    public void linkGithub(UUID userId, String code) {
        com.saga.application.port.ExternalUserProfile profile = externalIdentityPort.getGithubProfile(code);
    ...
    public void linkJira(UUID userId, String code) {
        com.saga.application.port.ExternalUserProfile profile = externalIdentityPort.getJiraProfile(code);
