package com.saga.user.infrastructure.controller;

import com.saga.shared.response.ApiResponse;
import com.saga.user.application.dto.UserResponseDTO;
import com.saga.user.application.service.UserQueryService;
...
import com.saga.user.application.service.UserCommandService;
...
public class AdminUserController {
    ...
    public ResponseEntity<ApiResponse<Page<UserResponseDTO>>> getStudents(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(userQueryService.getStudents(pageable), "Success"));
    }
    ...
    public ResponseEntity<ApiResponse<Page<UserResponseDTO>>> getLecturers(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(
                userQueryService.getLecturers(pageable),
    ...
    public ResponseEntity<ApiResponse<Page<UserResponseDTO>>> getAllUsers(Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(userQueryService.getAllUsers(pageable), "Success"));
    }
