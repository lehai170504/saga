...
public class ExternalIdentityAdapter implements ExternalIdentityPort {
        ...
        @Override
        public com.saga.identity.application.port.ExternalUserProfile getGithubProfile(String code) {
                ...
                return com.saga.identity.application.port.ExternalUserProfile.builder().id(id).name(name).email(email).build();
        }

        @Override
        public com.saga.identity.application.port.ExternalUserProfile getJiraProfile(String code) {
                HttpHeaders headers = new HttpHeaders();
