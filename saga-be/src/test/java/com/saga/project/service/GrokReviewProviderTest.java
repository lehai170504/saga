...
class GrokReviewProviderTest {

    private MockWebServer mockWebServer;
    private GrokReviewProvider grokReviewProvider;
    ...
    void setUp() throws IOException {
        ...
        grokReviewProvider = new GrokReviewProvider(webClientBuilder, "dummy-api-key",
                mockWebServer.url("/").toString(), objectMapper);
    }
    ...
    void testAnalyzeCommit_ValidResponse() {
        ...
        AiReviewResult result = grokReviewProvider.analyzeCommit("Fix login bug", "diff --git a/file b/file");
    ...
    void testAnalyzeCommit_MissingApiKey() {
        GrokReviewProvider serviceWithoutKey = new GrokReviewProvider(WebClient.builder(), "",
                mockWebServer.url("/").toString(), new ObjectMapper());
